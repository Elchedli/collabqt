...
void amine::on_Ajout_locataire_clicked()
{
...
void amine::on_supp_locataire_clicked()
{
...
void amine::on_modif_locataire_clicked()
{
...
void amine::on_Ajout_local_clicked()
{
...
void amine::on_modif_local_clicked()
{
...
void amine::on_supp_local_clicked()
{
...
void amine::on_Trier_locataire_clicked()
{
     ui->tabt->setModel(tmplocataire.afficherlct(ui->boxlct->currentText()));
}

void amine::on_lineRNOM_textChanged()
{
